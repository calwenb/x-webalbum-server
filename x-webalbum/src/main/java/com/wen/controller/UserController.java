...
public class UserController extends BaseController {
    ...
    public String login(@RequestParam("loginName") String loginName,
        ...
        LoggerUtil.info(user.getUserName() + " 登录" + "身份权限:" + user.getUserType(), UserController.class);
        ...
        //LoggerUtil.info(token, UserController.class);
    ...
    public String outLogin() {
        String token = tokenService.headerToken();
