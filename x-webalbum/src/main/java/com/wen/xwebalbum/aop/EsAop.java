...
public class EsAop {
    ...
    @Around("execution(* com.wen.xwebalbum.mapper.MyFileMapper.addFile(..))")
    ...
    @Around("execution(* com.wen.xwebalbum.mapper.MyFileMapper.deleteByMyFileId(..))")
    ...
    @Around("execution(* com.wen.xwebalbum.mapper.MyFileMapper.updateByFileId(..))")
